 ...
 ****
 **** PATCHED 
 **** 02/12/2016 - frzaplet - fixed ondragleave overlay removal
 ****
*/
	                ...
	                value: function addToQueue(files, options, filters) {
	                    ...
	                    forEach(list, function (some /*{File|HTMLInputElement|Object}*/) {
	                        ...
	                        if (_this._isValidFile(temp, arrayOfFilters, options)) {
	                            ...
	                            //support for files uploaded from cloud service
                                //cloudInfo holds necessary info for the upload
	                            if (some.cloudInfo) {
                                    fileItem.cloudInfo = some.cloudInfo;
                                }
